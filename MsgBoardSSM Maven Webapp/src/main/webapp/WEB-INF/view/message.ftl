		...
		<div class="WB_main clearfix" id="plc_frame">
			<div class="WB_frame">
				<div id="plc_main">
					<div class="WB_main_c">
						<div id="v6_pl_content_publishertop">
							<div class="send_weibo S_bg2 clearfix">
								<form action="${base }/leavedMessage.do" method="post">
									<div class="input">
									...
									<div class="WB_feed_detail clearfix">
										<div class="WB_screen W_fr">
											<div class="screen_box">
												<a >
													<i class="W_ficon ficon_arrow_down S_ficon">#${mess.msgId}</i>
												</a>
											</div>
										</div>
										<div class="WB_detail">
											<div class="WB_info">
												<a class="W_f14 W_fb S_txt1" >${mess.fromName }</a>
											</div>
											<div class="WB_text W_f14">${mess.msgContent }</div>
											<div class="WB_from S_txt2" style="text-align: right;">
												<a class="S_txt2"> ${(mess.msgTime)?string("yyyy年MM月dd日    HH:mm:ss")} </a>
											</div>
										</div>
									</div>
									<!--/主内容-->
									...
									<div class="WB_feed_handle">
										<div class="WB_handle">
											<ul class="WB_row_line WB_row_r3 clearfix S_line2">
												...
												<li>
													<a href="${base }/toComment.do?msgId=${mess.msgId }" class="S_txt1"> 
														<span class="pos">
								...
								<div class="WB_handle">
									<ul class="WB_row_line WB_row_r3 clearfix S_line2">
										<li style="width:120px;">
											...
											<#else>
											<a class="S_txt1" href="${base }/toMessage.do?keyword=${keyword }&startTime=${startTime }&endTime=${endTime }&curPage=1">
											</#if> 
												<span class="pos"> 
										...
										<li style="width:120px;">
											<#if (curPage>1)>
											<a class="S_txt1" href="${base }/toMessage.do?keyword=${keyword }&startTime=${startTime }&endTime=${endTime }&curPage=${curPage - 1}">
											<#else>
											<a class="S_txt1" style="color: gray;">
											</#if> 
												<span class="pos"> 
										...
										<li style="width:120px;">
											...
											<a class="S_txt1" style="color: gray;">
											<#else>
											<a class="S_txt1" href="${base }/toMessage.do?keyword=${keyword }&startTime=${startTime }&endTime=${endTime }&curPage=${pageCount }">
											</#if> 
												<span class="pos"> 
					...
					<div class="WB_main_r">
						<div class="nameBox">
							<form action="${base }/toMessage.do" method="post">
								<label>搜索留言： </label><input name="keyword" type="text"><hr>
